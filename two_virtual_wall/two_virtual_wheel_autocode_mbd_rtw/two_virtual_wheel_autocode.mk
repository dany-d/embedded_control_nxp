...
MODULES              = clock_S32K1xx.c clock_manager.c ftm0_pwm_params.c ftm3_pwm_params.c ftm_common.c ftm_hw_access.c ftm_ic_driver.c ftm_mc_driver.c ftm_oc_driver.c ftm_pwm_driver.c ftm_qd_driver.c interrupt_manager.c lpit_driver.c mbd_main.c pins_driver.c pins_port_hw_access.c power_manager.c power_manager_S32K1xx.c power_smc_hw_access.c s32k_clock_init.c startup.c system_S32K144.c
MAKEFILE             = two_virtual_wheel_autocode.mk
MATLAB_ROOT          = C:\Program Files\MATLAB\R2018a
ALT_MATLAB_ROOT      = C:\PROGRA~1\MATLAB\R2018a
START_DIR            = N:\lab_8\lab8files_W19
S_FUNCTIONS          = 
S_FUNCTIONS_LIB      = 
SOLVER               = 
NUMST                = 3
...
TARGET_COMPILER         = GCC
#--------------------------- GCC -----------------------
GCC_TARGET_CC_OPTS      = -mcpu=cortex-m4 -mthumb -mfloat-abi=hard -mfpu=fpv4-sp-d16 -O1 -g -gstrict-dwarf
...
ADD_INCLUDES = \
	...
	-$(include_opt)$(START_DIR)\two_virtual_wheel_autocode_mbd_rtw \
